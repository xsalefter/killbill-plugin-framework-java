 ...
 * <h1>handlers</h1>
 * <p>
 * There are few type of handlers: {@link Handler}, {@link OneArgHandler}
 * {@link ZeroArgHandler} and {@link Filter}. They behave very similar, except that a
 * {@link Filter} can decide if the next route handler can be executed or not. For example:
 * </p>
 *
 * <pre>
 ...
 * </pre>
 *
 * While a {@link Handler} always execute the next handler:
 *
 * <pre>
 ...
 * </pre>
 *
 * The {@link OneArgHandler} and {@link ZeroArgHandler} offers a functional version of
...
public interface Route {
  ...
  interface Props<T extends Props<T>> {
     ...
     * advanced routing. See {@link Chain#next(String, org.jooby.Request, Response)}
     *
     *
  ...
  /**
   * Collection of {@link Props} useful for registering/setting route options at once.
   *
  ...
  @SuppressWarnings({"unchecked", "rawtypes"}) class Collection implements Props<Collection> {
     ...
     */
    public Collection(final Props... definitions) {
  ...
  class Definition implements Props<Definition> {
     ...
     */
    public Definition(final String verb, final String pattern,
        final Handler handler, boolean caseSensitiveRouting) {
     ...
     * {@link Chain#next(String, org.jooby.Request, Response)}
     *
    ...
    private Route asRoute(final String method, final RouteMatcher matcher,
        final List<MediaType> produces, final Source source) {
   ...
   * </pre>
   *
   * NOTE: Don't forget to call {@link Chain#next(org.jooby.Request, Response)} if next route handler
   * need to be executed.
   *
   * @author edgar
   * @since 0.1.0
  ...
  public interface Filter {
     ...
     * The {@link Chain} passed in to this method allows the Filter to pass on the request and
     ...
     * <li>
     * <ul>
     * <li><strong>Either</strong> invoke the next entity in the chain using the {@link Chain}
     ...
     */
    void handle(org.jooby.Request req, Response rsp, Chain chain) throws Throwable;
  }
  ...
  class AssetDefinition extends Definition {
    ...
    public AssetDefinition(final String method, final String pattern,
        final Filter handler, boolean caseSensitiveRouting) {
  ...
  /**
   * A route handler that always call {@link Chain#next(org.jooby.Request, Response)}.
   *
   * <pre>
   * public class MyApp extends Jooby {
   *   {
  ...
  interface Handler extends Filter {
    ...
    @Override
    default void handle(final org.jooby.Request req, final Response rsp, final Chain chain)
        throws Throwable {
      handle(req, rsp);
      chain.next(req, rsp);
    }
     ...
     */
    void handle(org.jooby.Request req, Response rsp) throws Throwable;
  ...
  interface OneArgHandler extends Filter {
     ...
     * @throws Throwable If something goes wrong. The exception will processed by Jooby.
     */
    Object handle(org.jooby.Request req) throws Throwable;
  }
   ...
   *
   * Please note that the <code>before</code> handler is just syntax sugar for {@link Filter}.
  ...
  interface Before extends Filter {
    ...
    @Override
    default void handle(final org.jooby.Request req, final Response rsp, final Chain chain) throws Throwable {
      handle(req, rsp);
      chain.next(req, rsp);
    }
  ...
  interface After extends Filter {
     ...
     */
    org.jooby.Result handle(org.jooby.Request req, Response rsp, Result result) throws Exception;
  }
  ...
  interface Complete extends Filter {
     ...
     */
    void handle(org.jooby.Request req, Response rsp, Optional<Throwable> cause);
  }
  ...
  interface Chain {
     ...
     */
    void next(@Nullable String prefix, org.jooby.Request req, Response rsp) throws Throwable;
     ...
     * @throws Throwable If invocation goes wrong.
     */
    default void next(final org.jooby.Request req, final Response rsp) throws Throwable {
      next(null, req, rsp);
    }
  ...
  /** Route key. */
  Key<Set<Definition>> KEY = Key.get(new TypeLiteral<Set<Definition>>() {
  });
   ...
   * {@link Chain#next(String, Request, Response)}
   *
