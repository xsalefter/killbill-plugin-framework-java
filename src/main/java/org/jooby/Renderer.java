...
public interface Renderer {
  ...
  interface Context {
    ...
    default boolean accepts(final String type) {
      return accepts(org.jooby.MediaType.valueOf(type));
    }
     ...
     * @return True if the given type matches the <code>Accept</code> header.
     */
    boolean accepts(final org.jooby.MediaType type);
     ...
     * @return This context.
     */
    Context type(org.jooby.MediaType type);
     ...
     * It will set a <code>Content-Type</code> to {@link org.jooby.MediaType#octetstream} if none was set.
     *
     ...
     *
     * It will set a <code>Content-Length</code> if none was set.
     * It will set a <code>Content-Type</code> to {@link org.jooby.MediaType#html} if none was set.
     *
