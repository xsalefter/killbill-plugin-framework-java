...
public class RequestImpl implements Request {
  ...
  public boolean matches(final String pattern) {
    org.jooby.internal.RoutePattern p = new RoutePattern("*", pattern);
  ...
  private Mutant _params(final Function<String, String> xss) {
    ...
    return new org.jooby.internal.MutantImpl(require(ParserExecutor.class), params);
  }
  ...
  private Mutant _param(final String name, final Function<String, String> xss) {
    ...
    if (param == null) {
      org.jooby.internal.StrParamReferenceImpl paramref = new org.jooby.internal.StrParamReferenceImpl("parameter", name,
                                                                                                       params(name, xss));
      param = new org.jooby.internal.MutantImpl(require(ParserExecutor.class), paramref);
  ...
  private Mutant _header(final String name, final Function<String, String> xss) {
    ...
    return new org.jooby.internal.MutantImpl(require(ParserExecutor.class),
                                             new org.jooby.internal.StrParamReferenceImpl("header", name, headers));
  }
  ...
  public Mutant body() throws Exception {
    ...
    if (length > 0) {
      ...
      return new org.jooby.internal.MutantImpl(require(ParserExecutor.class), type, body);
    }
