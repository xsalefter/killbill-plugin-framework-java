...
public interface Request extends Registry {
   ...
   * {@link LanguageRange} and filter while the second argument is a list of supported
   ...
   */
  @Nonnull
  List<Locale> locales(BiFunction<List<LanguageRange>, List<Locale>, List<Locale>> filter);
   ...
   */
  @Nonnull
  Locale locale(BiFunction<List<LanguageRange>, List<Locale>, Locale> filter);
   ...
   * {@link Jooby#use(Jooby.Module)} otherwise a call to this method ends in
