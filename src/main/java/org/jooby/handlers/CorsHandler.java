...
/**
 * Handle preflight and simple CORS requests. CORS options are set via: {@link org.jooby.handlers.Cors}.
 *
 * @author edgar
 * @since 0.8.0
 * @see org.jooby.handlers.Cors
 */
public class CorsHandler implements Route.Filter {
  ...
  /** The logging system. */
  private final Logger log = LoggerFactory.getLogger(org.jooby.handlers.Cors.class);

  private Optional<org.jooby.handlers.Cors> cors = Optional.empty();
   ...
   */
  public CorsHandler(final org.jooby.handlers.Cors cors) {
  ...
  public void handle(final Request req, final Response rsp, final Chain chain) throws Throwable {
    ...
    org.jooby.handlers.Cors cors = this.cors.orElseGet(() -> req.require(org.jooby.handlers.Cors.class));
  ...
  private void cors(final org.jooby.handlers.Cors cors, final Request req, final Response rsp,
