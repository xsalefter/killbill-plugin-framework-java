 ...
 * {@link OnClose},
 * {@link OnError} or {@link OnOpen} callbacks. Or if you want to
 * implement all them, then just {@link Handler}
 * </p>
 *
 * <h2>data types</h2>
 * <p>
...
public interface WebSocket extends Closeable, Registry {
  ...
  interface OnOpen {
     ...
     */
    void onOpen(org.jooby.Request req, WebSocket ws) throws Exception;
  }
  ...
  class Definition {
     ...
     * {@literal *}/{@literal *}.
     */
    private org.jooby.MediaType consumes = org.jooby.MediaType.plain;

    /**
     * Defines the media types that the methods of a resource class or can produces. Default is:
     * {@literal *}/{@literal *}.
     */
    private org.jooby.MediaType produces = org.jooby.MediaType.plain;
    ...
    public Definition consumes(final String type) {
      return consumes(org.jooby.MediaType.valueOf(type));
    }
     ...
     * @return This route definition.
     */
    public Definition consumes(final org.jooby.MediaType type) {
    ...
    public Definition produces(final String type) {
      return produces(org.jooby.MediaType.valueOf(type));
    }
     ...
     * @return This route definition.
     */
    public Definition produces(final org.jooby.MediaType type) {
     ...
     */
    public org.jooby.MediaType consumes() {
     ...
     */
    public org.jooby.MediaType produces() {
