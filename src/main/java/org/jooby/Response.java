...
public interface Response {
  ...
  class Forwarding implements Response {
    ...
    @Override
    public Response type(final org.jooby.MediaType type) {
      rsp.type(type);
      return this;
    }
    ...
    @Override
    public void send(final org.jooby.Result result) throws Throwable {
      rsp.send(result);
    }
    ...
    @Override
    public void after(final org.jooby.Route.After handler) {
      rsp.after(handler);
    }

    @Override
    public void complete(final org.jooby.Route.Complete handler) {
  ...
  default Response cookie(final String name, final String value) {
    return cookie(new Definition(name, value));
  }
   ...
   */
  @Nonnull
  Response cookie(final Definition cookie);
   ...
   */
  @Nonnull
  Optional<org.jooby.MediaType> type();
   ...
   */
  @Nonnull
  Response type(org.jooby.MediaType type);
  ...
  default void send(final @Nullable Object result) throws Throwable {
    if (result instanceof org.jooby.Result) {
      send((org.jooby.Result) result);
    } else if (result != null) {
      // wrap body
      org.jooby.Result b = Results.with(result);
   ...
   * @see org.jooby.Route.After
   */
  void after(org.jooby.Route.After handler);
