...
public class ServerSessionManagerTest {
  ...
  private Block cookie = unit -> {
    Definition session = unit.get(Definition.class);
  ...
  public void newServerSessionManager() throws Exception {
    new MockUnit(Config.class, Definition.class, Cookie.Definition.class,
        Store.class, ParserExecutor.class)
            .expect(noSecret)
            .expect(cookie)
            .expect(saveInterval(-1L))
            .expect(maxAge(-1))
            .run(unit -> {
              new ServerSessionManager(unit.get(Config.class), unit.get(Definition.class),
                                       unit.get(Store.class), unit.get(ParserExecutor.class));
            });
  }
  ...
  public void destroy() throws Exception {
    new MockUnit(Config.class, Definition.class, Cookie.Definition.class,
        Store.class, ParserExecutor.class, Session.class)
            .expect(noSecret)
            .expect(cookie)
            .expect(saveInterval(-1L))
            .expect(maxAge(-1))
  ...
  public void storeCreateSession() throws Exception {
    new MockUnit(Config.class, Definition.class, Cookie.Definition.class,
        Store.class, ParserExecutor.class, RequestScopedSession.class, SessionImpl.class)
            .expect(noSecret)
            .expect(cookie)
            .expect(saveInterval(-1L))
            .expect(maxAge(-1))
  ...
  public void noSession() throws Exception {
    new MockUnit(Config.class, Definition.class, Cookie.Definition.class,
        Store.class, ParserExecutor.class, Request.class, Response.class)
            .expect(noSecret)
            .expect(cookie)
            .expect(saveInterval(-1L))
            .expect(maxAge(-1))
  ...
  public void getSession() throws Exception {
    String id = "xyz";
    new MockUnit(Config.class, Definition.class, Cookie.Definition.class,
        Store.class, ParserExecutor.class, Request.class, Response.class, SessionImpl.class)
            .expect(noSecret)
            .expect(cookie)
            .expect(saveInterval(-1L))
            .expect(maxAge(-1))
