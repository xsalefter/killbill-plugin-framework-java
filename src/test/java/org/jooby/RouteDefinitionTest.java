...
public class RouteDefinitionTest {
  ...
  public void newHandler() throws Exception {
    new MockUnit(Request.class, Response.class, Route.Chain.class)
        ...
        .run(unit -> {
          Definition def = new Definition("GET", "/", (req, rsp, chain) -> {
            rsp.send("x");
          });
  ...
  public void newOneArgHandler() throws Exception {
    new MockUnit(Request.class, Response.class, Route.Chain.class)
        ...
        .run(unit -> {
          Definition def = new Definition("GET", "/", (req) -> {
            return "x";
          });
  ...
  public void newZeroArgHandler() throws Exception {
    new MockUnit(Request.class, Response.class, Route.Chain.class)
        ...
        .run(unit -> {
          Definition def = new Definition("GET", "/", () -> {
            return "x";
          });
  ...
  public void nullVerb() throws Exception {
    new Definition(null, "/", (req, rsp, chain) -> {
    });
  }

  @Test
  public void noMatches() throws Exception {
    Optional<Route> matches = new Definition("delete", "/", (req, rsp, chain) -> {
  ...
  public void chooseMostSpecific() throws Exception {
    Optional<Route> matches = new Definition("GET", "/", (req, rsp, chain) -> {
  ...
  public void consumesEmpty() throws Exception {
    new Definition("GET", "/", (req, rsp, chain) -> {
  ...
  public void properties() throws Exception {
    Definition def = new Definition("put", "/test/path", (req, rsp, chain) -> {
    })
        .name("test")
  ...
  public void reverse() throws Exception {
    Function<String, Definition> route = path -> new Definition("*", path, () -> null);
